...
import gr.aueb.cf.teacherapp.core.exception.EntityAlreadyExistsException;
import gr.aueb.cf.teacherapp.core.exception.EntityInvalidArgumentException;
...
public class TeacherService implements ITeacherService{
    ...
    public Teacher saveTeacher(TeacherInsertDTO dto)
        ...
        if (teacherRepository.findByVat(dto.getVat()).isPresent()) {
            throw new EntityAlreadyExistsException("Teacher", "Teacher with vat" + dto.getVat() + "alreadit exists.");
        }
